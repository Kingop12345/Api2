...
def configure_ngrok():
    ngrok_token = "2sAOWuVsbgs2pTmASAmbZVBGKTJ_7LY6vvFgVHsJrWKM8svX"
    while True:
        try:
...
def update_soul_txt(public_url):
    ...
    print(f"New ngrok link saved in soul4.txt")
...
def update_vps_soul_txt(public_url):
    ...
    try:
        ...
        sftp.close()
        ssh.close()
        print("Updated soul4.txt on VPS successfully.")
    except Exception as e:
        print(f"Failed to update soul4.txt on VPS: {str(e)}")
